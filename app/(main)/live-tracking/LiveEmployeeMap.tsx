  ...
  return <div className={`ops-console ${fullScreen ? "h-[calc(100dvh-110px)]" : "h-[calc(100dvh-155px)]"} min-h-[620px] bg-slate-50`}>
    ...
    <div className="ops-workspace">
      <div className="ops-map-wrap">
        ...
        <div className="absolute left-4 top-4 z-[500] rounded-full bg-white/95 px-3 py-1.5 text-[11px] font-medium text-slate-600 shadow">Latest {recentRoute.length} route points</div>
