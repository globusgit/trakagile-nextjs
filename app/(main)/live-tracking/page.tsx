...
export default function LiveTrackingPage() {
  ...
  return <div className="space-y-3 pb-4">
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      <div><h1 className="text-xl font-bold tracking-tight text-slate-900">Live tracking</h1><p className="text-sm text-slate-500">GPS updates every minute · Map refreshes every 15 seconds</p></div>
